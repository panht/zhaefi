...
<%
id=request("id")
sqltext="select * from v_research_result_detail where term_id="&id
...
e_count=rs("e_count")
f_count=rs("f_count")
all_count=a_count + b_count + c_count + d_count + e_count + f_count
rs.close
%>
<!DOCTYPE html>
...
<div class="fl mt10 ml10 wmain">
	<div class="c c2 fs18">问卷调查 - 查看统计 - <%=subject%><br>总计：<%=all_count%>票</div>
